...
#     likes = db.relationship('Like', backref='liked_blog_post', lazy=True)
...
#     blog_post = db.relationship('BlogPost', backref='liked_blog_post', lazy=True)
...
class CommunityFollowers(db.Model):
    _tablename_ = 'community_followers'
