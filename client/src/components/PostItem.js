...
const PostItem = ({ postID, title, content, userID, expertID, image, time }) => {
    ...
    const handleLike = async () => {
        try {
            const response = await fetch(`YOUR_API_ENDPOINT_HERE/posts/${postID}/likes`, {
                method: 'POST',
    ...
    const handleFollow = async () => {
        try {
            const response = await fetch(`YOUR_API_ENDPOINT_HERE/posts/${postID}/follows`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    const handleCommentSubmit = async (e) => {
        ...
        if (commentText.trim()) {
            try {
                const response = await fetch(`YOUR_API_ENDPOINT_HERE/posts/${postID}/comments`, {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
